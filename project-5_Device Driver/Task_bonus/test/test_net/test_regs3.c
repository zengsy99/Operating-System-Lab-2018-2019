...
static void recv_desc_init(mac_t *mac)
{
    ...
    Rx_desc[255].tdes0 = 0;
    Rx_desc[255].tdes1 = /*RxDisIntCompl | */ RxDescEndOfRing | RxDescChain | PSIZE*4;
    Rx_desc[255].tdes2 = ((int)Rx_buffer[255]) & 0x1fffffff;
    Rx_desc[255].tdes3 = ((int)&Rx_desc[0])   & 0x1fffffff;
