...
extern desc_t Tx_desc[PNUM];  // Send
extern desc_t Rx_desc[PNUM];  // Receive

extern uint32_t Tx_buffer[PNUM][PSIZE];  // Send
extern uint32_t Rx_buffer[PNUM][PSIZE];  // Receive
